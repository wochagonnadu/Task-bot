...
<table>
  <tr>
        <td align="center"><img src="./assets/images/security_invitation_code.PNG" alt="Пример кода приглашения" width="50%"></td>
        <td align="center"><img src="./assets/images/security_first_access_manager.PNG" alt="Запрос доступа от менеджера" width="50%"></td>
  </tr>
  <tr>
    <td align="center">1. Пришлашение для нового пользователя.</td>
    <td align="center">2. Бот запрашивает MASTER_KEY для первого входа.</td>
  </tr>
  <tr>
    <td align="center"><img src="./assets/images/security_first_access_manager_approved.PNG" alt="Доступ разрешен" width="50%"></td>
    <td align="center"><img src="./assets/images/access_denied.PNG" alt="Доступ запрещен" width="50%"></td>
  </tr>
  <tr>
